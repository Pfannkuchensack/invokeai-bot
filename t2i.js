...
async function t2i(config, prompt) {
return new Promise((resolve, reject) => {
  let imgurl = "";
  dotenv.config();
  batch.batch.graph.nodes["55705012-79b9-4aac-9f26-c0b10309785b"]["height"] =
    config.height;
  batch.batch.graph.nodes["55705012-79b9-4aac-9f26-c0b10309785b"]["width"] =
    config.width;
  batch.batch.graph.nodes["7d8bf987-284f-413a-b2fd-d825445a5d6c"]["prompt"] =
    prompt.positive;
  batch.batch.graph.nodes["93dc02a4-d05b-48ed-b99c-c9b616af3402"]["prompt"] =
    prompt.negative;
  batch.batch.graph.nodes["eea2702a-19fb-45b5-9d75-56b4211ec03c"]["steps"] =
    config.steps;
  batch.batch.graph.nodes["eea2702a-19fb-45b5-9d75-56b4211ec03c"]["cfg_scale"] =
    config.cfg;
  batch.batch.graph.nodes["eea2702a-19fb-45b5-9d75-56b4211ec03c"]["scheduler"] =
    config.scheduler;
